...
TCAMMatchTable::TCAMMatchTable(sc_module_name nm, pfp::core::PFPObject* parent,
      std::string configfile):TCAMMatchTableSIM(nm, parent, configfile) {
  /*sc_spawn threads*/
  ThreadHandles.push_back(sc_spawn(sc_bind(&TCAMMatchTable::TCAMMatchTableThread,
        this, 0)));
}
